$(function () {
	...
	var options = {
		...
		xaxis: {
			type: 'datetime',
			categories: ['1/11/2015', '2/11/2016', '3/11/2017', '4/11/2018', '5/11/2019', '6/11/2020'],
		},
		title: {
			text: 'Line Chart',
			align: 'left',
	...
	var optionsLine = {
		...
		labels: ['01/15/2016', '01/16/2017', '01/17/2018', '01/18/2019', '01/19/2020', '01/20/2021'],
		xaxis: {
			tooltip: {
				enabled: false
			}
	...
	var options = {
		...
		xaxis: {
			categories: ['Bangladesh', 'Filipina', 'Vietnam', 'Myanmar', 'Malaysia', 'Nepal', 'Japan', 'Singapura', 'China', 'Indonesia'],
		}
	};
