$(function () {
	...
	Highcharts.chart('chart5', {
		...
		title: {
			text: 'Browser market share, January, 2021'
		},
		subtitle: {
			text: 'Source: <a href="#" target="_blank">dc.com</a>'
		},
		plotOptions: {
			pie: {
				shadow: false,
	...
	Highcharts.chart('chart6', {
		...
		title: {
			text: 'Browser<br>shares<br>2020',
			align: 'center',
	...
	Highcharts.chart('chart10', {
		...
		title: {
			text: 'Browser market shares. January, 2021'
		},
		subtitle: {
			text: 'Click the columns to view versions. Source: <a href="#" target="_blank">dc.com</a>'
		},
		accessibility: {
			announceNewData: {
				enabled: true
	...
	Highcharts.chart('chart11', {
		...
		accessibility: {
			description: 'Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Minima eos distinctio doloribus iusto, eveniet odio assumenda. Quos autem, minima? Impedit quod deleniti quaerat tempore odio esse at labore autem quia laborum sapiente ipsa enim corrupti veniam repudiandae quas accusamus, amet sunt! Odio asperiores error aut, veniam ullam modi porro, enim!'
		},
		title: {
			text: 'Lorem, ipsum dolor sit amet'
		},
		subtitle: {
			text: 'Sources: <a href="https:#">' + 'wt.org</a> &amp; <a href="#">' + 'dc.org</a>'
		},
		xAxis: {
			allowDecimals: false,
			labels: {
	...
	Highcharts.chart('chart13', {
		...
		title: {
			text: 'Average Monthly Temperature and Rainfall in Makassar'
		},
		subtitle: {
			text: 'Source: dc.com'
		},
